...
public class RubotoActivity extends android.app.Activity {
  ...
  public android.app.Dialog onCreateDialog(int id) {
    if (callbackProcs[CB_CREATE_DIALOG] != null) {
      ...
      try {
        return (android.app.Dialog) getRuby().callMethod(callbackProcs[CB_CREATE_DIALOG], "call" , id, android.app.Dialog.class);
      } catch (RaiseException re) {
        re.printStackTrace();
        return null;
      }
  ...
  public void onPrepareDialog(int id, android.app.Dialog dialog) {
    if (callbackProcs[CB_PREPARE_DIALOG] != null) {
      ...
      try {
        getRuby().callMethod(callbackProcs[CB_PREPARE_DIALOG], "call" , new Object[]{id, dialog});
      } catch (RaiseException re) {
        re.printStackTrace();
      }
    } else {
